...
import { IconLoader2, IconDownload, IconTrendingUp, IconHourglassHigh, IconDatabase, IconHistory, IconSearch } from "@tabler/icons-react"
    ...
    >
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col p-6 space-y-6">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Laporan & Riwayat</h1>
            <p className="text-muted-foreground mt-1">
              Pantau laporan transaksi penjualan per periode dan audit log pergerakan stok inventori barang grosir.
            </p>
          </div>
