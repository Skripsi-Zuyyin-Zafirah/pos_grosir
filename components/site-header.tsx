...
const ROUTE_LABELS: Record<string, string> = {
  "/dashboard": "Dashboard",
  "/dashboard/pos": "POS Walk-in",
  "/dashboard/products": "Kelola Produk dan Stok",
  "/dashboard/satuan": "Kelola Satuan",
  "/dashboard/employee": "Kelola Pegawai",
  "/dashboard/queue": "Kasir & Pembayaran",
  "/dashboard/reports": "Laporan Transaksi",
